...
-&
\begin{aligned}[t]
&\text{Match pair,}\, \langle \mathtt{r},\mathtt{ss}\rangle, \mathtt{w_{ss}}\, \text{is the nearest-enclosing wait for \texttt{ss}}
\end{aligned}
\qquad&&\mathit{time}_\mathtt{r}\ \mathrm{\prec_{\mathtt{HB}}}\ \mathit{time}_\mathtt{w_{ss}}\\
-&
\begin{aligned}[t]
&\text{Sequential order over a nearest-enclosing wait}\, \mathtt{w}_\mathtt{ss}\\
&\text{for a synchronous send \texttt{ss} and a event}\, \mathtt{e}\in\{\mathtt{r},\mathtt{s},\mathtt{ss},\mathtt{rs}\}
\end{aligned}
\qquad && \mathit{time}_{\mathtt{w}_\mathtt{ss}} \prec_\mathtt{HB} \mathit{time}_\mathtt{e}
\end{alignat}
